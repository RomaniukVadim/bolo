...
class CaptchasDotNet
{
    ...
    function __random_string()
    {
        ...
        $random_string = '';
        for ($i = 0; $i < 40; $i++) {
            $random_string .= $letters{mt_rand(0, strlen($letters) - 1)};
        }
    ...
    function random()
    {
        ...
        for ($remaining = 20; $remaining > 0; $remaining--) {
            ...
            // error message.
            $filename = $this->__random_repository . '/captcha_' . $random;
    ...
    function image_url($random = False, $base = 'http://image.captchas.net/')
    {
        ...
        if ($this->__alphabet != 'abcdefghijklmnopqrstuvwxyz') {
            $image_url .= '&amp;alphabet=' . $this->__alphabet;
        };
        if ($this->__letters != 6) {
            $image_url .= '&amp;letters=' . $this->__letters;
        };
        if ($this->__width != 240) {
            $image_url .= '&amp;width=' . $this->__width;
        };
        if ($this->__height != 80) {
            $image_url .= '&amp;height=' . $this->__height;
        };
        if ($this->__color != '000000') {
            $image_url .= '&amp;color=' . $this->__color;
        };
        return $image_url;
    }
    ...
    function audio_url($random = False, $base = 'http://audio.captchas.net/')
    {
        ...
        if ($this->__alphabet != 'abcdefghijklmnopqrstuvwxyz') {
            $audio_url .= '&amp;alphabet=' . $this->__alphabet;
        };
        if ($this->__letters != 6) {
            $audio_url .= '&amp;letters=' . $this->__letters;
        };
        return $audio_url;
    }
...
EOT;
    ...
    function validate($random)
    {
        ...
        $file_name = $this->__random_repository . '/captcha_' . $random;
